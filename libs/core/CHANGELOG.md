...
* **core:** do not use barrel exports for services ([60e1edc](https://github.com/orchestratora/orchestrator/commit/60e1edcc943ae21b61e78b1f9afc8b7ebd62569e))
...
* **core:** type of items in config interface ([3818ac8](https://github.com/orchestratora/orchestrator/commit/3818ac8ed2e1cb8e3f3bcac57be092cb4807dea1))
...
* **core:** add @OptionFunction decorator ([6e75ac7](https://github.com/orchestratora/orchestrator/commit/6e75ac76184a49918bf797c544b5a7e2c86dbd1d)), closes [#28](https://github.com/orchestratora/orchestrator/issues/28)
* **core:** add attributes and classes to every dynamic item ([38081f9](https://github.com/orchestratora/orchestrator/commit/38081f947b50744213eadfd2aa237d7835f7e7bd))
...
* **core:** add decoding functions from metadata ([2ef01b3](https://github.com/orchestratora/orchestrator/commit/2ef01b39f5b9d202ce16b44fd02de8b656d46220)), closes [#28](https://github.com/orchestratora/orchestrator/issues/28)
...
* **core:** add validation/decoding of component configurations ([6b43dcc](https://github.com/orchestratora/orchestrator/commit/6b43dcc6a240e7be55886300320006332747682d)), closes [#25](https://github.com/orchestratora/orchestrator/issues/25)
* **core:** allow to clear all items via `RenderItemComponent` ([b32fcb9](https://github.com/orchestratora/orchestrator/commit/b32fcb9f9cafa79910695aaaba4e938b25c84618))
...
* **core:** resolve arguments of functions in configs ([6f0cada](https://github.com/orchestratora/orchestrator/commit/6f0cada28aec609504efa5c1cabd31dbb64aa019)), closes [#28](https://github.com/orchestratora/orchestrator/issues/28)
